...
const Cards = ({ cards, nomad }) => {
  return (
    ...
    {nomad &&  <a
        ...
        className={`flex items-center justify-center gap-[8px] bg-[#E9E8E8CC] rounded-[100px] h-[29px] sm:h-[35px] px-[16px] text-[10px] lg:text-xs font-semibold whitespace-nowrap uppercase bg-[#393939] text-[white]`}
      >
        nomad.arch
