...
const Case9Page = () => {
  ...
  const type1Data = {
    title1: 'Гости могли выбрать формат вечера на свой вкус: фуршет и нетворкинг на первом этаже, зона активных игр с возможностью заработать виртуальные деньги для участия в финальном аукционе, приглушенная музыка на втором этаже или lounge-зона с авторскими кальянами на уютной веранде.',
    title2:
