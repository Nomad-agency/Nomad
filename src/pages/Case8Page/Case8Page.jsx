...
const Case8Page = () => {
  ...
  const type1Data = {
    title1: 'Мы разработали креативную концепцию мерча под названием «БезПредел возможностей», которая отражает потенциал роста и развития каждого сотрудника в компании. В рамках этой идеи был создан внутренний инвестиционный словарь, ставший ключевым элементом дизайна вещей. Концепция символизирует потенциал роста и развития каждого сотрудника в компании.',
    title2:
