...
const Case6Page = () => {
  ...
  const type1Data1 = {
    title1: 'Основное событие проиходило внутри: гости ходили на иммерсивные экскурсии по внутреннему пространству, чтобы из реальных историй узнать, как BODIUM меняет жизни людей и какой потенциал он раскрывает в наших телах и сознании.',
