...
const Case2Page = () => {
  ...
  return (
    <main className="container mx-auto">
      ...
      {/* Section 2 */}
      <img src={image1} alt="photo1" className="mt-5 md:mt-[50px] w-full h-auto" loading='lazy'/>
      ...
      {/* Section 7 */}
      <img src={image7} alt="photo7" className="mt-5 md:mt-[50px] w-full h-auto" loading='lazy'/>

      {/* Section 8 */}
      <HalfText 
        title={'Создали библиотеку 3D-элементов, чтобы усилить визуальное присутствие бренда и повысить его узнаваемость. \nТакже разработали дизайн для различных indoor- и outdoor-носителей.'}
      />
      ...
      {/* Section 10 */}
      <img src={image10} alt="photo10" className="mt-5 md:mt-[50px] w-full h-auto" loading='lazy'/>
